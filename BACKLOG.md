...
**Current behaviour:** a sender from a different Workspace domain, or a personal Gmail account, fails with a `403 PERMISSION_DENIED` (`CliError::PeopleApiError`) rather than a name — there is no fallback.

...
## [0.3.0](https://github.com/lucabro81/CLI-monorepo/releases/tag/google-chat-v0.3.0) - 2026-07-11

### Added

- *(google-chat)* require --select or --select-all before printing full JSON
...
- *(google-chat)* bump version to 0.3.0 to work around release-plz registry check
